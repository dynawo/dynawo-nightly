...
if [ "$TRAVIS_OS_NAME" = "linux" ]; then
  ...
  cat /Users/travis/build/dynawo/dynawo-nightly/dynawo/build/clang4.2.1/master/Debug-cxx11/shared/dynawo/sources/Models/Modelica/PreassembledModels/UnderVoltageAutomaton.log
